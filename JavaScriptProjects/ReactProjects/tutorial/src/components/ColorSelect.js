...
const ColorSelect = ({selectedColor, setColor}) => {
  ...
  function onColorSelect (newColor) {
  ...
  function onColorCustom (newColor) {
    const oldColor = selectedColor;
...
ColorSelect.propTypes = {
  color: PropTypes.string.isRequired, //React.State<string>
  setColor: PropTypes.func.isRequired, //React.Dispatch<React.SetStateAction<string>>
}
