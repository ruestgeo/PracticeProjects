...
public class GameRoomConfigs {
    ...
    */
    ...
    private GameRoomConfigs (String json){
        Json configs = JsonFactory.parse(json);
        short temp_short;
        ...
        this.totalMobWeight =  this.randomMobWeights.values().stream().reduce(0, (a,b) -> a + b); //Integer::sum  //gives warning
        ...
        this.numFixedMobs = this.fixedMobAmounts.values().stream().reduce(0, (a,b) -> a + b);
