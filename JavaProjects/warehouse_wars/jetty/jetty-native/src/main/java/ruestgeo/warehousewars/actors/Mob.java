package ruestgeo.warehousewars.actors;
...
public abstract class Mob extends Actor {
    ...
    /***
     * @return the direction the Mob is moving in
     */
    public List<Json> getDirectionList () {
        List<Json> list = new ArrayList<Json>(2);
        list.add(null);
        list.add(null);
        list.set(0, JsonFactory.create(this.direction[0]));
        list.set(1, JsonFactory.create(this.direction[1]));
        return list;
    }
